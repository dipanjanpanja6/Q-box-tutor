...
const mapToState = (state) => ({
  panddingcourse: state.admin.rejectWeekly,
});
const mapToProps = {
  GetRejectCourse,
  DeleteCourse,
};
export default connect(mapToState, mapToProps)(AlertWeekly);
